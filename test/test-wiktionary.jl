...
import WikitextParser: wiki_freelink, wiki_external_link, wiki_template
...
import WikitextParser: wikitext, wikitextParser
...
import WikitextParser: template_inner
...
ParserAlchemy.result_type(wikitext)
import WikitextParser: wiki_template
ParserAlchemy.result_type(wiki_template(nothing))
...
import WikitextParser: wiki_lines
...
using WikitextParser: number_line, wikitextParser
tokenize(alt(wiki_lines...),":[1] ''kurz für:'' [[Schraubenmutter]], welche das Gegenstück zu der [[Schraube]] bildet\n")

mutter = read("WikitextParser/test/mutter.wikitext",String);
